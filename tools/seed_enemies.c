...
static EnemyDef defs[] = {
    /* name           hp  atk def siz spd int per  flags                                              xp gold */
    ...
    { "Giant Spider",  16,  5,  1,  2,  3,  1,  4,  EDEF_EXECUTABLE | EDEF_STUNNABLE,                10,  2, {0} },
    { "Dark Mage",    14,  8,  1,  1,  2,  5,  2,  EDEF_EXECUTABLE,                                 18,  4, {0} },
};
